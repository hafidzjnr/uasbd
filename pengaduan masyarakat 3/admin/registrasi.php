        <div class="row">
          <div class="col s12 m9">
            <h3 class="white-text"><b>Masyarakat</b></h3>
          </div>  
	...
	<?php 
		...
		<tr>
			...
			<td>
				<a class="btn black pink-text modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> 
				<a onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" class="btn pink black-text" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<input type="submit" name="simpan" value="Simpan" class="btn black pink-text ">
				</div>
			</form>
